...
import net.luna.common.entity.CacheObject;
import net.luna.common.entity.FailedReason;
import net.luna.common.service.impl.FileNameRuleImageUrl;
import net.luna.common.service.impl.ImageCache;
import net.luna.common.service.impl.ImageSDCardCache;
import net.luna.common.service.impl.RemoveTypeLastUsedTimeFirst;
import net.luna.common.service.impl.ImageMemoryCache.OnImageCallbackListener;
import net.luna.common.service.impl.ImageSDCardCache.OnImageSDCallbackListener;
import net.luna.common.service.impl.PreloadDataCache.OnGetDataListener;
