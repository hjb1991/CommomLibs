...
//		ToastUtil.showMessage(context, "无法连接网络");
	...
	public static String getProvider() {
		String provider = "未知";
		try {
			TelephonyManager telephonyManager = (TelephonyManager) applicationContext.getSystemService(
	...
	private static int getNetworkClass() {
		...
		try {
			final NetworkInfo network = ((ConnectivityManager) applicationContext.getSystemService(
	...
	public static String getImei() {
		TelephonyManager mTelephonyMgr = (TelephonyManager) applicationContext.getSystemService(
				Context.TELEPHONY_SERVICE);
...
//		try {
//			TelephonyManager mTelephonyManager = (TelephonyManager) applicationContext.getSystemService(
//					Context.TELEPHONY_SERVICE);
