package net.luna.commom.util;

import net.luna.commom.entity.CacheObject;
import net.luna.commom.entity.FailedReason;
import net.luna.commom.service.impl.FileNameRuleImageUrl;
import net.luna.commom.service.impl.ImageCache;
import net.luna.commom.service.impl.ImageSDCardCache;
import net.luna.commom.service.impl.RemoveTypeLastUsedTimeFirst;
import net.luna.commom.service.impl.ImageMemoryCache.OnImageCallbackListener;
import net.luna.commom.service.impl.ImageSDCardCache.OnImageSDCallbackListener;
import net.luna.commom.service.impl.PreloadDataCache.OnGetDataListener;
